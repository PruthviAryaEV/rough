...
var questions =[
	...
	function Displayquestion()
	{
		...
		{
			board.innerHTML="<p class='p1'> You got "+cor+" of "+questions.length;
		...
		board.innerHTML+="<label><input type='radio' class='option-input radio' name='choices' value='A'>"+A+"</label>"+"<br>";
